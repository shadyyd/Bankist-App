...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-11-10T14:11:59.604Z',
    '2023-11-13T17:01:17.194Z',
    '2023-11-15T23:36:17.929Z',
...
const startLogOutTimer = function () {
  ...
  const tick = function () {
    ...
    //when 0sec ,stop timer and logout
    if (time === 0) {
      clearInterval(timer);
...
// console.log('US:      ', Intl.NumberFormat('en-US').format(num));
// console.log('Germany: ', Intl.NumberFormat('de-DE').format(num));
// console.log('Syria:   ', Intl.NumberFormat('ar-SY').format(num));
// console.log(navigator.language);
// console.log('Browser: ', Intl.NumberFormat(navigator.language).format(num));
